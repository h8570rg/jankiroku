...
create table "_analytics"."log_events_2e74dfac_bf62_42f6_9c11_c58f1094495f" (
...
create table "_analytics"."log_events_3b101667_4f82_40bf_89bd_9079b49458b2" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_4bbcb5f4_b23f_484b_bb10_d5e36295ff79" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_6e5b1208_3489_46b3_b08b_ac7808fb0556" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_80fc4042_b2e1_4152_b1e1_fe6e73492d2e" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_cff04189_6884_4495_88a0_af535b8ae43a" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_f8820cf8_bb3a_44e7_a478_6015c1739095" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."log_events_fd8498b6_09bd_4ae9_bf93_006b5623b0da" (
    "id" character varying(255) not null,
    "body" jsonb,
    "event_message" text,
    "timestamp" timestamp without time zone
...
create table "_analytics"."schema_migrations_2e74dfac_bf62_42f6_9c11_c58f1094495f" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_3b101667_4f82_40bf_89bd_9079b49458b2" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_4bbcb5f4_b23f_484b_bb10_d5e36295ff79" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_6e5b1208_3489_46b3_b08b_ac7808fb0556" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_80fc4042_b2e1_4152_b1e1_fe6e73492d2e" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_cff04189_6884_4495_88a0_af535b8ae43a" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_f8820cf8_bb3a_44e7_a478_6015c1739095" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);


create table "_analytics"."schema_migrations_fd8498b6_09bd_4ae9_bf93_006b5623b0da" (
    "version" bigint not null,
    "inserted_at" timestamp(0) without time zone
);
...
CREATE UNIQUE INDEX log_events_2e74dfac_bf62_42f6_9c11_c58f1094495f_pkey ON _analytics.log_events_2e74dfac_bf62_42f6_9c11_c58f1094495f USING btree (id);

CREATE UNIQUE INDEX log_events_3b101667_4f82_40bf_89bd_9079b49458b2_pkey ON _analytics.log_events_3b101667_4f82_40bf_89bd_9079b49458b2 USING btree (id);

CREATE UNIQUE INDEX log_events_4bbcb5f4_b23f_484b_bb10_d5e36295ff79_pkey ON _analytics.log_events_4bbcb5f4_b23f_484b_bb10_d5e36295ff79 USING btree (id);

CREATE UNIQUE INDEX log_events_6e5b1208_3489_46b3_b08b_ac7808fb0556_pkey ON _analytics.log_events_6e5b1208_3489_46b3_b08b_ac7808fb0556 USING btree (id);

CREATE UNIQUE INDEX log_events_80fc4042_b2e1_4152_b1e1_fe6e73492d2e_pkey ON _analytics.log_events_80fc4042_b2e1_4152_b1e1_fe6e73492d2e USING btree (id);

CREATE UNIQUE INDEX log_events_cff04189_6884_4495_88a0_af535b8ae43a_pkey ON _analytics.log_events_cff04189_6884_4495_88a0_af535b8ae43a USING btree (id);

CREATE UNIQUE INDEX log_events_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7_pkey ON _analytics.log_events_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7 USING btree (id);

CREATE UNIQUE INDEX log_events_f8820cf8_bb3a_44e7_a478_6015c1739095_pkey ON _analytics.log_events_f8820cf8_bb3a_44e7_a478_6015c1739095 USING btree (id);

CREATE UNIQUE INDEX log_events_fd8498b6_09bd_4ae9_bf93_006b5623b0da_pkey ON _analytics.log_events_fd8498b6_09bd_4ae9_bf93_006b5623b0da USING btree (id);
...
CREATE UNIQUE INDEX schema_migrations_2e74dfac_bf62_42f6_9c11_c58f1094495f_pkey ON _analytics.schema_migrations_2e74dfac_bf62_42f6_9c11_c58f1094495f USING btree (version);

CREATE UNIQUE INDEX schema_migrations_3b101667_4f82_40bf_89bd_9079b49458b2_pkey ON _analytics.schema_migrations_3b101667_4f82_40bf_89bd_9079b49458b2 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_4bbcb5f4_b23f_484b_bb10_d5e36295ff79_pkey ON _analytics.schema_migrations_4bbcb5f4_b23f_484b_bb10_d5e36295ff79 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_6e5b1208_3489_46b3_b08b_ac7808fb0556_pkey ON _analytics.schema_migrations_6e5b1208_3489_46b3_b08b_ac7808fb0556 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_80fc4042_b2e1_4152_b1e1_fe6e73492d2e_pkey ON _analytics.schema_migrations_80fc4042_b2e1_4152_b1e1_fe6e73492d2e USING btree (version);

CREATE UNIQUE INDEX schema_migrations_cff04189_6884_4495_88a0_af535b8ae43a_pkey ON _analytics.schema_migrations_cff04189_6884_4495_88a0_af535b8ae43a USING btree (version);

CREATE UNIQUE INDEX schema_migrations_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7_pkey ON _analytics.schema_migrations_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_f8820cf8_bb3a_44e7_a478_6015c1739095_pkey ON _analytics.schema_migrations_f8820cf8_bb3a_44e7_a478_6015c1739095 USING btree (version);

CREATE UNIQUE INDEX schema_migrations_fd8498b6_09bd_4ae9_bf93_006b5623b0da_pkey ON _analytics.schema_migrations_fd8498b6_09bd_4ae9_bf93_006b5623b0da USING btree (version);
...
alter table "_analytics"."log_events_2e74dfac_bf62_42f6_9c11_c58f1094495f" add constraint "log_events_2e74dfac_bf62_42f6_9c11_c58f1094495f_pkey" PRIMARY KEY using index "log_events_2e74dfac_bf62_42f6_9c11_c58f1094495f_pkey";

alter table "_analytics"."log_events_3b101667_4f82_40bf_89bd_9079b49458b2" add constraint "log_events_3b101667_4f82_40bf_89bd_9079b49458b2_pkey" PRIMARY KEY using index "log_events_3b101667_4f82_40bf_89bd_9079b49458b2_pkey";

alter table "_analytics"."log_events_4bbcb5f4_b23f_484b_bb10_d5e36295ff79" add constraint "log_events_4bbcb5f4_b23f_484b_bb10_d5e36295ff79_pkey" PRIMARY KEY using index "log_events_4bbcb5f4_b23f_484b_bb10_d5e36295ff79_pkey";

alter table "_analytics"."log_events_6e5b1208_3489_46b3_b08b_ac7808fb0556" add constraint "log_events_6e5b1208_3489_46b3_b08b_ac7808fb0556_pkey" PRIMARY KEY using index "log_events_6e5b1208_3489_46b3_b08b_ac7808fb0556_pkey";

alter table "_analytics"."log_events_80fc4042_b2e1_4152_b1e1_fe6e73492d2e" add constraint "log_events_80fc4042_b2e1_4152_b1e1_fe6e73492d2e_pkey" PRIMARY KEY using index "log_events_80fc4042_b2e1_4152_b1e1_fe6e73492d2e_pkey";

alter table "_analytics"."log_events_cff04189_6884_4495_88a0_af535b8ae43a" add constraint "log_events_cff04189_6884_4495_88a0_af535b8ae43a_pkey" PRIMARY KEY using index "log_events_cff04189_6884_4495_88a0_af535b8ae43a_pkey";

alter table "_analytics"."log_events_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7" add constraint "log_events_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7_pkey" PRIMARY KEY using index "log_events_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7_pkey";

alter table "_analytics"."log_events_f8820cf8_bb3a_44e7_a478_6015c1739095" add constraint "log_events_f8820cf8_bb3a_44e7_a478_6015c1739095_pkey" PRIMARY KEY using index "log_events_f8820cf8_bb3a_44e7_a478_6015c1739095_pkey";

alter table "_analytics"."log_events_fd8498b6_09bd_4ae9_bf93_006b5623b0da" add constraint "log_events_fd8498b6_09bd_4ae9_bf93_006b5623b0da_pkey" PRIMARY KEY using index "log_events_fd8498b6_09bd_4ae9_bf93_006b5623b0da_pkey";
...
alter table "_analytics"."schema_migrations_2e74dfac_bf62_42f6_9c11_c58f1094495f" add constraint "schema_migrations_2e74dfac_bf62_42f6_9c11_c58f1094495f_pkey" PRIMARY KEY using index "schema_migrations_2e74dfac_bf62_42f6_9c11_c58f1094495f_pkey";

alter table "_analytics"."schema_migrations_3b101667_4f82_40bf_89bd_9079b49458b2" add constraint "schema_migrations_3b101667_4f82_40bf_89bd_9079b49458b2_pkey" PRIMARY KEY using index "schema_migrations_3b101667_4f82_40bf_89bd_9079b49458b2_pkey";

alter table "_analytics"."schema_migrations_4bbcb5f4_b23f_484b_bb10_d5e36295ff79" add constraint "schema_migrations_4bbcb5f4_b23f_484b_bb10_d5e36295ff79_pkey" PRIMARY KEY using index "schema_migrations_4bbcb5f4_b23f_484b_bb10_d5e36295ff79_pkey";

alter table "_analytics"."schema_migrations_6e5b1208_3489_46b3_b08b_ac7808fb0556" add constraint "schema_migrations_6e5b1208_3489_46b3_b08b_ac7808fb0556_pkey" PRIMARY KEY using index "schema_migrations_6e5b1208_3489_46b3_b08b_ac7808fb0556_pkey";

alter table "_analytics"."schema_migrations_80fc4042_b2e1_4152_b1e1_fe6e73492d2e" add constraint "schema_migrations_80fc4042_b2e1_4152_b1e1_fe6e73492d2e_pkey" PRIMARY KEY using index "schema_migrations_80fc4042_b2e1_4152_b1e1_fe6e73492d2e_pkey";

alter table "_analytics"."schema_migrations_cff04189_6884_4495_88a0_af535b8ae43a" add constraint "schema_migrations_cff04189_6884_4495_88a0_af535b8ae43a_pkey" PRIMARY KEY using index "schema_migrations_cff04189_6884_4495_88a0_af535b8ae43a_pkey";

alter table "_analytics"."schema_migrations_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7" add constraint "schema_migrations_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7_pkey" PRIMARY KEY using index "schema_migrations_d7290d82_b603_4c57_8fbc_8d7e92ca4fd7_pkey";

alter table "_analytics"."schema_migrations_f8820cf8_bb3a_44e7_a478_6015c1739095" add constraint "schema_migrations_f8820cf8_bb3a_44e7_a478_6015c1739095_pkey" PRIMARY KEY using index "schema_migrations_f8820cf8_bb3a_44e7_a478_6015c1739095_pkey";

alter table "_analytics"."schema_migrations_fd8498b6_09bd_4ae9_bf93_006b5623b0da" add constraint "schema_migrations_fd8498b6_09bd_4ae9_bf93_006b5623b0da_pkey" PRIMARY KEY using index "schema_migrations_fd8498b6_09bd_4ae9_bf93_006b5623b0da_pkey";
